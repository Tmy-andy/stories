...
- 2026-04-16 `[FIX]` `LOW` — Ghi chú → `<details>` collapsible, gradient tím, hỗ trợ multi-line + ảnh → [entry](entries/2026-04-16-003-ghi-chu-collapsible-details.md) · commit: `(chưa commit)`
