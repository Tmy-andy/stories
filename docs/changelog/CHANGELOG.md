...
- 2026-04-17 `[FIX]` `MEDIUM` — Fix @mention gợi ý + hiển thị mention nổi bật + noti dẫn tới chapter → [entry](entries/2026-04-17-004-fix-mention-suggestions-va-noti-chapter.md) · commit: (chưa commit)
