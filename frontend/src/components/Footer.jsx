    ...
    <footer className="bg-secondary-light dark:bg-secondary-dark border-t border-gray-200 dark:border-white/10 mt-16 w-full">
      <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12">
          ...
          <Link to="/about" className="text-sm text-text-muted-light dark:text-text-muted-dark hover:text-primary dark:hover:text-primary transition-colors">
            Về chúng tôi
          </Link>
          <Link to="/terms-and-conditions" className="text-sm text-text-muted-light dark:text-text-muted-dark hover:text-primary dark:hover:text-primary transition-colors">
            Điều khoản sử dụng
          </Link>
          <Link to="/privacy-policy" className="text-sm text-text-muted-light dark:text-text-muted-dark hover:text-primary dark:hover:text-primary transition-colors">
            Chính sách bảo mật
          </Link>
        </div>
